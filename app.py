...
st.set_page_config(page_title='Экстрактор знаний', page_icon='📋', layout='wide')
...
if 'loader' not in st.session_state:
    ...
    st.session_state.classifier = TextClassifier('models/model.pkl')
            ...
            with st.spinner('Обработка...'):
                try:
                    ...
                    if not df.empty:
                        ...
                        st.dataframe(df.sample(min(10, len(df)))[['text', 'score', 'has_metrics', 'predict']])
