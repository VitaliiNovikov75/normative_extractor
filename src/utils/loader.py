...
class MeganormLoader:
    ...
    def extract_clean_text(self, html: str) -> str:
        ...
        # Удаляю скрипты, стили, таблицы и подписи к ним,
        # чтобы они не попали в сегментацию
        for tag in content_node.css('script, style, ins, ads, table, thead, tbody, tfoot, img, svg, canvas, picture, math, annotation'):
            tag.decompose()
